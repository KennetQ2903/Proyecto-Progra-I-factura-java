...
//        Image closeIcon = kit.createImage(dir + "\\resources\\close (3).png");
//        cmdClose.setIcon(new ImageIcon(closeIcon));
        initComponents();
        init(message);
        initAnimator();
    }
    ...
    private void init(String message) {
        ...
        Image success = kit.createImage(dir + "\\resources\\checked.png");
        Image info = kit.createImage(dir + "\\resources\\info.png");
        Image warning = kit.createImage(dir + "\\resources\\warning.png");

        if (type == Type.SUCCESS) {
            lbIcon.setIcon(new ImageIcon(success));
            lbMessage.setText("Exito");
        } else if (type == Type.INFO) {
            lbIcon.setIcon(new ImageIcon(info));
            lbMessage.setText("Informacion");
        } else {
            lbIcon.setIcon(new ImageIcon(warning));
            lbMessage.setText("Advertencia");
        }
    ...
    private void initComponents() {
        ...
        cmdClose.setForeground(new java.awt.Color(102, 102, 102));
        cmdClose.setText("X");
